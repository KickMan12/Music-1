...
module.exports = {
  ...
  execute(message, args, client) {
    ...
    message.reply(new MessageEmbed().setColor("#2aa200").setTitle("Remix Bot Invite ✨").setDescription("✔️ **[Click Here](https://discord.com/api/oauth2/authorize?client_id=919204082441420820&permissions=8&scope=bot) to invite the bot.**")
